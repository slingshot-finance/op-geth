...
void bench_context_verify(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 20; i++) {
        secp256k1_context_destroyOP(secp256k1_context_createOP(SECP256K1_CONTEXT_VERIFY));
    }
}
...
void bench_context_sign(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 200; i++) {
        secp256k1_context_destroyOP(secp256k1_context_createOP(SECP256K1_CONTEXT_SIGN));
    }
}
